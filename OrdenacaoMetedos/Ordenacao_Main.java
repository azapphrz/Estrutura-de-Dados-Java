...
public class Ordenacao_Main {
	...
	// Instancie e inicialize a classe OrdenaÃ§Ã£o
	...
	public static void main(String[] args) {
		...
		// Crie um vetor de inteiros, e gere 10 números aleatorios
		int[] dados = order.geradorAleatorio(10, 10);
		
		// Exiba o vetor de números aleatorios
		System.out.println("Numeros: " + order.exibirVetor(dados));
		
		// Instancie um vetor resultado, que contem o resultado da ordenação
