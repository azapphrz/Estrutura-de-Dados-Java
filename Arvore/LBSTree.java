...
class LBSTreeNode {
	...
	LBSTreeNode linkLeft; // Referencia para um item � esquerda
	LBSTreeNode linkRight; // Referencia para um item � direita
...
public class LBSTree {
	...
	public void retirar(Object item, LBSTreeNode treeRef) {
		...
		if(vazia()) { // Verificar se a arvore esta vazia
			System.out.println("EERO: �rvore vazia!");
